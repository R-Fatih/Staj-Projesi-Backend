...
namespace Narevim.Server.Data.Migrations
{
    ...
    [Migration("20230829142649_17.26")]
    partial class _1726
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Narevim.Shared.Address", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("billing_city_id")
                        .HasColumnType("int");

                    b.Property<int?>("billing_cityid")
                        .HasColumnType("int");

                    b.Property<string>("billing_clear_address")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("billing_surname")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("billing_telephone")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("billing_town_id")
                        .HasColumnType("int");

                    b.Property<int?>("billing_townid")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("clear_address")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("billing_cityid");

                    b.HasIndex("billing_townid");
            ...
            modelBuilder.Entity("Narevim.Shared.Brand", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Narevim.Shared.Cargo", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Narevim.Shared.Favoritte", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Narevim.Shared.Order", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("member_adress")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Narevim.Shared.OrderProduct", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Narevim.Shared.Address", b =>
                {
                    b.HasOne("Narevim.Shared.City", "billing_city")
                        .WithMany()
                        .HasForeignKey("billing_cityid");

                    b.HasOne("Narevim.Shared.Town", "billing_town")
                        .WithMany()
                        .HasForeignKey("billing_townid");

                    b.HasOne("Narevim.Shared.City", "city")
                        .WithMany()
                        .HasForeignKey("cityid");

                    b.HasOne("Narevim.Shared.Town", "town")
                        .WithMany()
                        .HasForeignKey("townid");

                    b.Navigation("billing_city");

                    b.Navigation("billing_town");
